            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-6/12 px-1">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="text"
                    className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 rounded text-sm focus:outline-none focus:ring w-full ease-linear transition-all duration-150 outline-none shadow-none border-[1px] border-gray-200 bg-whitesmoke font-medium  text-gray-600"
              ...
              <div className="w-full lg:w-6/12 px-1">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="email"
                    className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 rounded text-sm focus:outline-none focus:ring w-full ease-linear transition-all duration-150 outline-none shadow-none border-[1px] border-gray-200 bg-whitesmoke font-medium  text-gray-600 focus:border-gray-400 focus:bg-transparent"
              ...
              <div className="w-full px-1">
                <div className="relative w-full mb-3">
                  ...
                  <textarea
                    type="text"
                    className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 rounded text-sm focus:outline-none focus:ring w-full ease-linear transition-all duration-150 outline-none shadow-none border-[1px] border-gray-200 bg-whitesmoke font-medium  resize-none text-gray-600 focus:border-gray-400 focus:bg-transparent"
                    rows="4"
                    readOnly
