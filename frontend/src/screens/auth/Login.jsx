...
//                   <button
//                     type="submit"
//                     className="bg-blue-gradient text-white rounded  md:min-h-[52px] min-h-[48px] uppercase  font-semibold tracking-[1px] shadow-button md:mt-3 mt-1 hover:scale-105 default-transition text-sm sm:text-base"
//                   >
//                     proceed to login
//                   </button>
//                 </form>
...
//                   <Link
//                     to="/forgot-password"
//                     className="text-dark font-semibold  sm:text-base text-sm ms-2"
//                   >
//                     Forgot Password?
//                   </Link>
//                 </div>
