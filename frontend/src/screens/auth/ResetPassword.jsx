              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    {showPassword ? (
                      <FaEye className="text-indigo/80" />
                    ) : (
                      <FaEyeSlash className="text-indigo/80" />
                    )}
                    <button
                      type="button"
                      className="text-indigo/80 cursor-pointer text-sm font-medium"
                  ...
                  <ul className="box mt-3 border border-blue-gray-100 p-3 rounded-lg ">
                    <li
                      className={`text-[13px] ${
                        upperCase ? "text-green-500" : "text-theme"
                    ...
                    <li
                      className={`text-[13px] ${
                        number ? "text-green-500" : "text-theme"
                      } flex items-center gap-2`}
                    >
                      {switchIcon(number)}
                      Number (0-9)
                    ...
                    <li
                      className={`text-[13px] ${
                        specialChar ? "text-green-500" : "text-theme"
                      } flex items-center gap-2`}
                    >
                    ...
                    <li
                      className={`text-[13px] ${
                        passwordLength ? "text-green-500" : "text-theme"
                      } flex items-center gap-2`}
                    >
                  ...
                  <button
                    type="submit"
                    className="bg-blue-gradient text-white rounded md:min-h-[52px] min-h-[48px] uppercase  font-semibold tracking-[1px] shadow-button mt-1 hover:scale-105 default-transition text-sm sm:text-base"
                  >
                    reset password
                  </button>
                </form>
