  ...
  return (
    <div className="px-2 group">
      <div className="card text-center relative">
        ...
        <h2
          className="mt-5  uppercase font-semibold tracking-[1px] absolute bottom-4 right-4 bg-white text-dark/70 px-3 rounded-[6px] text-xs py-[4px] flex items-center justify-center group-hover:text-moonstone default-transition"
          style={{
