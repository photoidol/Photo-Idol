                    ...
                    <tr key={index} className="even:bg-blue-gray-50/50">
                      ...
                      <td className={classes}>
                        ...
                        <Typography
                          variant="small"
                          color="blue-gray"
                          className="font-normal capitalize inline-flex gap-x-1.5"
                        >
                      ...
                      <td className={classes}>
                        <div className="w-max">
                          <Chip
                            ...
                            className={`text-white border-2 flex items-center justify-center bg-transparent rounded-full w-[30px] h-[30px] font-medium ${
                              isVerified
                      ...
                      <td className={classes}>
                        {role !== ROLE_ADMIN ? (
                          ...
                          <div className="uppercase font-semibold text-sm text-center bg-moonstone text-white py-2">
                            Admin
                          </div>
                        )}
                      </td>
