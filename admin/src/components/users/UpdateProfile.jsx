  ...
  return (
    <form onSubmit={saveProfile}>
      <div className="flex flex-col gap-8 xl:flex-row xxl:items-start">
        <Card className="shadow-none w-[290px] mx-auto bg-white p-4">
          <label
            htmlFor="avatar"
        ...
        <div className="flex-auto lg:px-10 py-8 max-w-[720px] mx-auto xxl:ms-0 bg-white rounded-md shadow-lg">
          <div>
